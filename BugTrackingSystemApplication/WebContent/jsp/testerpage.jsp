                                ...
                                <span class="navbar-text">
                                    <div class="collapse navbar-collapse" id="navbarText">
                                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                            <li class="nav-item">
                                                <a class="btn btn-warning" href="../jsp/testerpage.jsp" role="button"><i
                                                        class="fas fa-user"></i> Profile</a>
                                            </li>&nbsp;&nbsp;&nbsp;
                                            <li class="nav-item">
                                                <a class="btn btn-warning" href="../jsp/testerdisplayproject.jsp"
                                                    role="button"><i class="fas fa-tasks"></i> Projects</a>
                                            </li>&nbsp;&nbsp;&nbsp;
                                            <li class="nav-item">
                                                <a class="btn btn-warning" href="../jsp/treportbug.jsp" role="button"><i
