            ...
            <body>
                ...
                <form action="../jsp/CreateNewProjectServlet" method="POST">
                    <div class="container">
                        ...
                        <br>
                        <label for="sdate"><b>Start Date</b></label><br>
                        <input type="date" placeholder="Choose the starting date" name="sdate" id="sdate"
                            required><br><br>
                        <textarea placeholder="Enter Description" name="desc" id="desc" required rows="2"
                            cols="80"></textarea><br>
                        <label for="team"><b>Assign Team Members</b></label>
                        <!---- Select Developers--><br>
                        <a class="btn btn-warning" href="../jsp/CreateNewProjectServlet" role="button"><i
                                class="fas fa-sign-out-alt"></i> Select
                            TeamMembers</a>
                        <br><br>
